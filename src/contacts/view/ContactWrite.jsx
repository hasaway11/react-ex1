...
function ContactWrite() {
  ...
  const {profile, profileUrl, change} = profileInput;
  ...
  return (
    <> 
      <div style={{height:'200px'}}> 
        {profileUrl && <img src={profileUrl} style={{height:'200px', objectFit:'cover'}} alt="프로필 사진" />}
      </div>
      <div className='mb-3 mt-3'>
        <label className='form-label'>프로필:</label>
        <input type='file' className='form-control' name="profile" onChange={change} />
      </div>
